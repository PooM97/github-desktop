...
import { getVersion, getName, getFolkVersion } from './lib/app-proxy'
import {
  getOS,
...
export class App extends React.Component<IAppProps, IAppState> {
    ...
    switch (popup.type) {
      ...
      case PopupType.About:
        const version = __DEV__
          ? __SHA__.substring(0, 10)
          : getVersion() + ` (${getFolkVersion()})`
  ...
  private onRepositoryToolbarButtonContextMenu = () => {
    ...
    const items = generateRepositoryListContextMenu({
      ...
      onViewOnGitHub: this.viewOnGitHub,
      onViewOnRemote: this.viewOnRemote,
      repository: repository,
